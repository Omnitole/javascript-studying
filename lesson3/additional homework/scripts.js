...
let emptyArray5 = [];
for(let i = 0;i<20;i++){
    emptyArray5[i] = Math.round(Math.random()*(10-1)+1)
}
console.log(emptyArray5)
// d. Заповнити масив 20ма рандомними чисалами в діапазоні від 8 до 732 (Google: Generate random number JS)
let emptyArray6 = [];
for(let i = 0;i<20;i++){
    emptyArray6[i] = Math.round(Math.random()*(732-8)+8)
}
console.log(emptyArray6)
// 2. Вивести за допомогою console.log кожен третій елемен
for(let i = 2; i<emptyArray6.length;i+=3){
    console.log(emptyArray6[i])
}
// 3. Вивести за допомогою console.log кожен третій елемен тільки якщо цей елемент є парним.
for(let i = 2; i<emptyArray6.length;i+=3){
    if(emptyArray6[i]%2===0){
    console.log(emptyArray6[i])
    }
}
// 4. Вивести за допомогою console.log кожен третій елемен тільки якщо цей елемент є парним та записати їх в новий масив
let emptyArray7 = [];
for(let i = 2,j=0; i<emptyArray6.length;i+=3){
    if(emptyArray6[i]%2===0){
        emptyArray7[j] = emptyArray6[i];
        j++
        console.log(emptyArray6[i])
    }
}
console.log(emptyArray7)
// 5. Вивести кожен елемент масиву, сусід справа якого є парним
// EXAMPLE: [ 1, 2, 3, 5, 7, 9, 56, 8, 67 ] -> Має бути виведено 1, 9, 56
let testArray = [ 1, 2, 3, 5, 7, 9, 56, 8, 67 ];
for(let i=0;i<testArray.length;i++){
    if(testArray[i+1]%2===0){
...
let averageCheck = amount/checks.length
console.log(averageCheck)
// 7. Створити масив з рандомними значеннями, помножити всі його елементи на 5 та перемістити їх в інший масив.

let randomNumbers = [];
for(let i = 0;i<20;i++){
    randomNumbers[i] = Math.round(Math.random()*(10-1)+1)
}
let newArrayForRandomNumbers = [];
for(let i=0;i<randomNumbers.length;i++){
    newArrayForRandomNumbers[i] = randomNumbers[i]*5
}
console.log(randomNumbers)
console.log(newArrayForRandomNumbers)
// 8. Створити масив з будь якими значеннями (стрінги, числа, і тд...). пройтись по ньому, і якщо елемент є числом - додати його в інший масив.
let mixedArray = [-124154141,true,'aboba',false,22,true,false,1000,`pizza`,25,1];
let onlyNumbersArray = [];
for(let i=0,j=0;i<mixedArray.length;i++){
    if(typeof mixedArray[i]==="number"){
        onlyNumbersArray[j] = mixedArray[i];
        j++
    }
}
...
let numbersArray2 = [1,125415,1515234,6457456,75468756,856,857698,5678576,856855,20];
for (const number of numbersArray2) {
    if(number%2===0){
        console.log(number)
    }
}
...
let l = 0;
let result2 = '';
while(l<finalArray.length){
    result2 = result2+finalArray[l]
    l++
}
console.log(result2)
...
for (const post of posts) {
    ...
    document.write(`<h3>ID - ${post.id}, ${post.title}</h3>`);
